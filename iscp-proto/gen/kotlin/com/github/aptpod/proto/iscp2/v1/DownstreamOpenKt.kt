...
@kotlin.jvm.JvmName("-initializedownstreamOpen")
public inline fun downstreamOpen(block: com.github.aptpod.proto.iscp2.v1.DownstreamOpenKt.Dsl.() -> kotlin.Unit): com.github.aptpod.proto.iscp2.v1.DownstreamOpen =
  com.github.aptpod.proto.iscp2.v1.DownstreamOpenKt.Dsl._create(com.github.aptpod.proto.iscp2.v1.DownstreamOpen.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `iscp2.v1.DownstreamOpen`
 */
public object DownstreamOpenKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.github.aptpod.proto.iscp2.v1.DownstreamOpen.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.github.aptpod.proto.iscp2.v1.DownstreamOpen.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.github.aptpod.proto.iscp2.v1.DownstreamOpen = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.github.aptpod.proto.iscp2.v1.DownstreamOpen.copy(block: `com.github.aptpod.proto.iscp2.v1`.DownstreamOpenKt.Dsl.() -> kotlin.Unit): com.github.aptpod.proto.iscp2.v1.DownstreamOpen =
  `com.github.aptpod.proto.iscp2.v1`.DownstreamOpenKt.Dsl._create(this.toBuilder()).apply { block() }._build()
