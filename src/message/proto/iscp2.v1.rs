...
impl ResultCode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::MaximumDataIdAlias => "MAXIMUM_DATA_ID_ALIAS",
            Self::MaximumUpstreamAlias => "MAXIMUM_UPSTREAM_ALIAS",
            Self::UnspecifiedError => "UNSPECIFIED_ERROR",
            Self::NoNodeId => "NO_NODE_ID",
            ...
            Self::InvalidDataId => "INVALID_DATA_ID",
            Self::InvalidDataIdAlias => "INVALID_DATA_ID_ALIAS",
            Self::InvalidDataFilter => "INVALID_DATA_FILTER",
            Self::StreamNotFound => "STREAM_NOT_FOUND",
            Self::ResumeRequestConflict => "RESUME_REQUEST_CONFLICT",
            Self::ProcessFailed => "PROCESS_FAILED",
            Self::DesiredQosNotSupported => "DESIRED_QOS_NOT_SUPPORTED",
            Self::PingTimeout => "PING_TIMEOUT",
            Self::TooLargeMessageSize => "TOO_LARGE_MESSAGE_SIZE",
            Self::TooManyDataIdAliases => "TOO_MANY_DATA_ID_ALIASES",
            Self::TooManyStreams => "TOO_MANY_STREAMS",
            Self::TooLongAckInterval => "TOO_LONG_ACK_INTERVAL",
            Self::TooManyDownstreamFilters => "TOO_MANY_DOWNSTREAM_FILTERS",
            Self::TooManyDataFilters => "TOO_MANY_DATA_FILTERS",
            Self::TooLongExpiryInterval => "TOO_LONG_EXPIRY_INTERVAL",
            Self::TooLongPingTimeout => "TOO_LONG_PING_TIMEOUT",
            ...
            Self::SessionCannotClosed => "SESSION_CANNOT_CLOSED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
